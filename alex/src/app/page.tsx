    ...
    <>
      ...
      <Container >
        ...
        <Col lg={3} md={4} sx={6}>
          ...
          <h5 style={{backgroundColor:'#45B39D'}} className='m-0 p-3 text-center  text-light fw-light'>Web Designing</h5>
          </Card>
        </Col>
        <Col lg={3} md={4} sx={6}>
          <Card className='shadow mt-5'>
          <Image src='/home/2023002.png' alt='Loading' fluid/>
          <h5 style={{backgroundColor:'#45B39D'}} className='m-0 p-3 text-center  text-light fw-light'>Web Development</h5>
          </Card>
        </Col>
        <Col lg={3} md={4} sx={6}>
          <Card className='shadow mt-5'>
          <Image src='/home/2023003.png' alt='Loading' fluid/>
          <h5 style={{backgroundColor:'#45B39D'}} className='m-0 p-3 text-center  text-light fw-light'>Logo Designing</h5>
          </Card>
        </Col>
        <Col lg={3} md={4} sx={6}>
          <Card className='shadow mt-5'>
          <Image src='/home/2023004.png' alt='Loading' fluid/>
          <h5 style={{backgroundColor:'#45B39D'}} className='m-0 p-3 text-center  text-light fw-light'>Search Engine Optimize</h5>
          </Card>
        </Col>
        <Col lg={3} md={4} sx={6}>
          <Card className='shadow mt-5'>
          <Image src='/home/2023005.png' alt='Loading' fluid/>
          <h5 style={{backgroundColor:'#45B39D'}} className='m-0 p-3 text-center  text-light fw-light'>IT Solution</h5>
          </Card>
        </Col>
        <Col lg={3} md={4} sx={6}>
          <Card className='shadow mt-5'>
          <Image src='/home/2023006.png' alt='Loading' fluid/>
          <h5 style={{backgroundColor:'#45B39D'}} className='m-0 p-3 text-center  text-light fw-light'>Graphic Designing</h5>
          </Card>
        </Col>
        <Col lg={3} md={4} sx={6}>
          <Card className='shadow mt-5'>
          <Image src='/home/2023007.png' alt='Loading' fluid/>
          <h5 style={{backgroundColor:'#45B39D'}} className='m-0 p-3 text-center  text-light fw-light'>Email Marketing</h5>
          </Card>
        </Col>
        <Col lg={3} md={4} sx={6}>
          <Card className='shadow mt-5'>
          <Image src='/home/2023008.png' alt='Loading' fluid/>
          <h5 style={{backgroundColor:'#45B39D'}} className='m-0 p-3 text-center  text-light fw-light'>Social Marketing</h5>
          </Card>
        </Col>
      </Row>
    <hr />
