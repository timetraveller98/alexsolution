...
import User from '@/app/data.json'
  ...
  return (
    <>
      ...
      <Container >
        <Row>
          ...
          <Col md={6} className='p-4'>
            ...
            <h4 className='fw-light my-4' style={{ color: 'gray' }}>Expand your business with Alex Solution's team</h4>
      ...
      <Container >
        ...
        <Col lg={3} md={4} sx={6}>
          ...
          <Image src={`/home/${item.id}.png`} alt='Loading' fluid/>
         <Link href={`/service/${item.id}`}><h6 style={{backgroundColor:'#6082B6',cursor:'pointer'}} className='m-0 p-3 text-center text-uppercase text-light fw-light rounded'>{item.name}</h6></Link>
          </Card>
        </Col>
    ...
    <hr />
      ...
      <Container >
        ...
        <Col md={6} className='p-4 my-4'>
         <h2 style={{color:'#6082B6'}} className='fw-light'>Web Designing & Development</h2>
         <h5 style={{color:'#6082B6'}} className='fw-light my-3'>Services that We Offer</h5>
         <ul>
        ...
        <Col md={{order:'first'}} className='p-4 my-4'>
         <h2 style={{color:'#6082B6'}} className='fw-light'>Digital Marketing</h2>
         <h5 style={{color:'#6082B6'}} className='fw-light my-3'>Services that We Offer</h5>
         <ul>
        ...
        <Col md={6} className='p-4 my-4'>
         <h2 style={{color:'#6082B6'}} className='fw-light'>Graphic Design</h2>
         <h5 style={{color:'#6082B6'}} className='fw-light my-3'>Services that We Offer</h5>
         <ul>
      ...
      <Card.Body className='bg-light'>
        <Card.Title className='fw-light text-center'style={{color:'#6082B6'}}>Pooja Kumari</Card.Title>
        <hr />
      ...
      <Card.Body className='bg-light'>
        <Card.Title className='fw-light text-center'style={{color:'#6082B6'}}>Pardeep Sharma</Card.Title>
        <hr />
        <Card.Text className='fw-light'>
      ...
      <Card.Body className='bg-light'>
        <Card.Title className='fw-light text-center' style={{color:'#6082B6'}}>Priya Thakur</Card.Title>
        <hr />
        <Card.Text className='fw-light'>
      ...
      <Card.Body className='bg-light'>
        <Card.Title className='fw-light text-center'style={{color:'#6082B6'}}>Sudhesh Kumar</Card.Title>
        <hr />
        <Card.Text className='fw-light'>
      ...
      <Card.Body className='bg-light'>
        <Card.Title className='fw-light text-center'style={{color:'#6082B6'}}>Deep Sandhu</Card.Title>
        <hr />
        <Card.Text className='fw-light'>
      ...
      <Card.Body className='bg-light'>
        <Card.Title className='fw-light text-center'style={{color:'#6082B6'}}>Divya Mittal</Card.Title>
        <hr />
        <Card.Text className='fw-light'>
